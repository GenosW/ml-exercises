...
target_path = "target/decision_tree/"
        ...
        for d in max_depth:
            for s in min_samples_split:
                for l in min_samples_leaf:
                    ...
                    rf = DecisionTreeClassifier( max_depth=d, random_state=random_state, criterion="gini", min_samples_split=s, min_samples_leaf=l)
                    rf.fit(X, y)
...
def main():
    ...
    value_mapping = {}
    value_mapping["n_estimators"] = [ 2049]
